    ...
    <Section title="Profilo Utente" icon="👤" T={T}>
      <div className="space-y-8">
          ...
          <div className="relative flex items-center space-x-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm font-medium backdrop-blur-sm">
                  {getProviderIcon(user.providerData[0]?.providerId)} {getProviderName(user.providerData[0]?.providerId)}
                </span>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'security' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Impostazioni di Sicurezza</h3>
                ...
                <div className="flex items-center justify-between p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center">
                      <span className="text-white">{getProviderIcon(user.providerData[0]?.providerId)}</span>
                    </div>
                    <div>
                      <p className="font-medium text-purple-800">Provider: {getProviderName(user.providerData[0]?.providerId)}</p>
